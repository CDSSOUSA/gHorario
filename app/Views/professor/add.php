                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-6">
                                ...
                                <span class="invalid-feedback"><?php echo $erro !== '' ? $erro->getError('nNome') : ''; ?></span>
                            </div>
                            <div class="form-group col-6">
                                ...
                                <span class="invalid-feedback"><?php echo $erro !== '' ? $erro->getError('nNumeroAulas') : ''; ?></span>
                        ...
                        <div class="row">
                            <div class="form-group col-4">
                                ...
                                <span class="invalid-feedback"><?php echo $erro !== '' ? $erro->getError('nCorDestaque') : ''; ?></span>
                            ...
                            <div class="form-group col-8">
                                ...
                                <?php endforeach ?>
                                <span class="invalid-feedback"><?php echo $erro !== '' ? $erro->getError('nDisciplinas') : ''; ?></span>
